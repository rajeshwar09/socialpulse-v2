...
TABLE_SPECS = {
  ...
  "gold.query_performance_summary": TableSpec(
    ...
    partition_by=["run_date"],
    description="Dashboard-ready daily overview KPIs aggregated across all executed YouTube queries.",
    schema_fields={
      "run_date": "string",
      "source_name": "string",
      "ingestion_mode": "string",
  ...
  "gold.topic_daily_kpis": TableSpec(
    ...
    partition_by=["run_date"],
    description="Dashboard-ready daily KPIs aggregated by topic and genre.",
    schema_fields={
      "run_date": "string",
      "source_name": "string",
      "ingestion_mode": "string",
